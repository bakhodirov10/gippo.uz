...
const admin_invite_guard_1 = require("../../common/guards/admin-invite.guard");
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Patient account created successfully' }),
...
__decorate([
    (0, public_decorator_1.Public)(),
    (0, common_1.UseGuards)(admin_invite_guard_1.AdminInviteGuard),
    ...
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid Admin Invitation Secret' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Authenticate user & issue JWT tokens' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Refresh JWT Access Token via Token Rotation' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Logout and revoke active refresh tokens' }),
